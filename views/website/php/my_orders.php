        ...
        <div class="content">
            ...
            <div class="card-account">
                <div class="user-card">
                    ...
                    <div class="user-name">
                    <div class="john-doe"><?php echo $_SESSION['username'] ?? 'John Doe'; ?></div>
                    </div>
                </div>
                <div class="menus">
                    ...
                    <a href="<?php echo $ROOT; ?>/views/website/change_password.php" class="account-menu">
                    ...
                    <div class="filters">
                        <div class="filter2" id="statusFilter">
                            ...
                            <div class="attribute2">
                                <span id="statusLabel">Pending Confirmation</span>
