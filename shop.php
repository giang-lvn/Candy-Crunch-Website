...
// Start session để kiểm tra wishlist
...
<body>
  ...
  <section class="banner" aria-label="Product listing banner">
    <img class="banner-image" alt="Candy banner" src="../../website/img/shop-banner.webp" />
  </section>
  ...
  <main class="main-section">
    ...
    <div class="top-section">
          ...
          <section class="filter-section" aria-label="Filter by rating">
            ...
            <div class="rating-row" aria-label="Filter by rating">
              <button type="button" class="rating-star-btn" data-value="1">
                <svg class="svg-star" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28"
                  fill="none">
                  <path
      ...
      <div class="right-container">
          ...
          <div class="filter-result-top">
            ...
            <div class="filter-controls">
              <div class="search-box">
                ...
                <svg class="search-icon" width="18" height="18" viewBox="0 0 16 24" fill="none" aria-hidden="true">
                  <path
              ...
              <div class="sort-box">
                ...
                <div class="sort-select-wrapper">
                  ...
                  <span class="dropdown-arrow">
                    <!-- icon drop-down -->
                    <svg class="icon-down" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                      fill="none">
                      <path d="M13.3145 5.34271L7.99988 10.6573L2.6853 5.34271" stroke="#FAFAFA" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg>

                    <!-- icon drop-up -->
                    <svg class="icon-up" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                      fill="none">
                      <path d="M2.71582 10.6421L8.00004 5.35788L13.2843 10.6421" stroke="white" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </span>
                </div>
        ...
        <!-- Product grid - rendered by JavaScript -->
    ...
    <div class="pagination">
      ...
      <div class="pagination-controls">
        ...
        <div class="page-jump">
          ...
          <input id="page-jump-input" class="page-jump-input" type="number" min="1" value="1" inputmode="numeric" />
        </div>
      </div>
    </div>
