...
class ShopManager {
  ...
  // ============================================
    ...
    async addToCart(product) {
      ...
      try {
        const response = await fetch('/controllers/website/shop_controller.php?action=add-to-cart', {
          method: 'POST',
          body: formData
        });
    ...
    async loadProducts() {
      try {
          ...
          const response = await fetch('/controllers/website/shop_controller.php'); 
